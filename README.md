...
## Pull the day-24 lesson

To add the day-24 lesson as its own folder without copying the source repository's Git history:

```bash
npx degit coltonsharp-dev/ALA2627-ASD-Coursework/week-07/day-24 day-24
cd day-24
```
